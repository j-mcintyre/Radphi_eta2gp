...
will further reduce the background using sideband subtraction and then determine the Eta cross-section.
...
Histograms for eta meson. These contain tag weighted (accidental subtracted) plots of
