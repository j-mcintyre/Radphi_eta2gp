...
void TwoG_may_14_2023::Begin(TTree * /*tree*/)
{
   TString option = GetOption();
}

void TwoG_may_14_2023::SlaveBegin(TTree * /*tree*/)
{
   TString option = GetOption();
...
Bool_t TwoG_may_14_2023::Process(Long64_t entry)
{
...
void TwoG_may_14_2023::SlaveTerminate()
{
  
}

void TwoG_may_14_2023::Terminate()
{
   // Write histograms to the output file
   fHistFile = new TFile("TwoG_may_14_2023Analysis.root", "RECREATE");   // Declare output file
...
//////////////////////////////////////////////////////
   ...
   double TwoG_may_14_2023::constrain_angle(double x) {
      double anglex;
      x = remainder(x, 360.0);
      if (x < 0) {
         x += 360.0;
   ...
   double TwoG_may_14_2023::angle_diff(double angle1, double angle2) {
   ...
   double TwoG_may_14_2023::delta_energy(int n_coin, float tagger_energy[30], double particle_ener) {
      double del_ener = 0.0;
