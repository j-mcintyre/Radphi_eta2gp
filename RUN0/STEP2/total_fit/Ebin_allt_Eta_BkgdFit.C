...
// ------------------------------------------------
// This files name     --> Ebin_allt_Eta_BkgdFit
// Real data root file --> TwoG_may_14_2023Analysis.root
...
void  Ebin_allt_Eta_BkgdFit() {

   // Root file with new histograms for reference in later analysis work
  	TFile *MyFile = new TFile("TwoG_may_14_2023_STEP2.root", "NEW");


   // Lower edge of |t| bins
	TH1D *hBinDW = new TH1D("hBinDW", "#eta tbin[Bin No.][0] value;Bin No.;|t| value [GeV^2/c^{4}]", 20, 0, 20);
   hBinDW->Sumw2();

   // Upper edge of |t| bins
	TH1D *hBinUP = new TH1D("hBinUP", "#eta tbin[Bin No.][1] value;Bin No.;|t| value [GeV^2/c^{4}]", 20, 0, 20);
   hBinUP->Sumw2();
   ...
   for (int Echannel = 0; Echannel < NumEChan; Echannel++) {
      ...
      */
      ...
      TString hdirName;
      // Root file with new histograms for reference in later analysis work
      TFile *MyFile = new TFile("TwoG_may_14_2023_STEP2.root", "UPDATE");

		if (Echannel == 0) {
         SBRANGE->SetBinContent(1, EtaLower);
         SBRANGE->SetBinContent(2, EtaLow);
         SBRANGE->SetBinContent(3, Etadown);
         SBRANGE->SetBinContent(4, Etaup);
         SBRANGE->SetBinContent(5, EtaHigh);
         SBRANGE->SetBinContent(6, EtaHigher);
         ...
         SBRANGE2->SetBinContent(1, EtaLower);
         SBRANGE2->SetBinContent(2, EtaLow);
         SBRANGE2->SetBinContent(3, Etadown);
         SBRANGE2->SetBinContent(4, Etaup);
         SBRANGE2->SetBinContent(5, EtaHigh);
         SBRANGE2->SetBinContent(6, EtaHigher);
         ...
         SBRANGE3->SetBinContent(1, EtaLower);
         SBRANGE3->SetBinContent(2, EtaLow);
         SBRANGE3->SetBinContent(3, Etadown);
         SBRANGE3->SetBinContent(4, Etaup);
         SBRANGE3->SetBinContent(5, EtaHigh);
         SBRANGE3->SetBinContent(6, EtaHigher);
         ...
         SBRANGE4->SetBinContent(1, EtaLower);
         SBRANGE4->SetBinContent(2, EtaLow);
         SBRANGE4->SetBinContent(3, Etadown);
         SBRANGE4->SetBinContent(4, Etaup);
         SBRANGE4->SetBinContent(5, EtaHigh);
         SBRANGE4->SetBinContent(6, EtaHigher);
      ...
      Bkhtitle.Form("Bkgd_parameters_allt_E%d", Echannel);
		...
		ofstream output;
		output.open("2g_E_binned_Eta_fit_allt_TwoG_may_14_2023.txt", std::ios_base::app);
		...
		if (output.is_open()) {
         ...
         if (Echannel == 0) {
			...
			output << "|t| = 0.1 to 1.9 GeV^2/c^4 -- Using XEta_bins[20][2]" << std::endl;
			output << std::endl;
         ...
         output << "EtaLower  = " << EtaLower << std::endl;
         output << "EtaLow    = " << EtaLow << std::endl;
         output << "Etadown   = " << Etadown << std::endl;
         output << "Etaup     = " << Etaup << std::endl;
         output << "EtaHigh   = " << EtaHigh << std::endl;
         output << "EtaHigher = " << EtaHigher << std::endl;
